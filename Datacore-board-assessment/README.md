...
em cũng chưa sử dụng tốt các công cụ để có thể nhìn được dữ liệu trên file Parquet, nên sau khi tạo file em đã đọc lại nó và in ra liệu ra Terminal để kiểm chứng